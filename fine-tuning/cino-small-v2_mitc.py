...
model = XLMRobertaForSequenceClassification.from_pretrained("../model/cino-small-v2", num_labels=11, id2label=id2label, label2id=label2id)

training_args = TrainingArguments(
    output_dir="../saved_model/cino-small-v2_mitc",
