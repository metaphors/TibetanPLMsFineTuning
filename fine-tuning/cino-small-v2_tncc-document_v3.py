...
model = XLMRobertaForSequenceClassification.from_pretrained("../model/cino-small-v2", num_labels=12, id2label=id2label, label2id=label2id)

training_args = TrainingArguments(
    output_dir="../saved_model/cino-small-v2_tncc-document_v3",
...
dataset = load_dataset("../dataset_loader/tncc-document_v3.py")

tokenizer = XLMRobertaTokenizer.from_pretrained("../model/cino-small-v2")
