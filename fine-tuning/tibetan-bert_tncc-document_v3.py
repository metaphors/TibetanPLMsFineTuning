...
model = BertForSequenceClassification.from_pretrained("../model/tibetan-bert", num_labels=12, id2label=id2label, label2id=label2id)

training_args = TrainingArguments(
    output_dir="../saved_model/tibetan-bert_tncc-document_v3",
