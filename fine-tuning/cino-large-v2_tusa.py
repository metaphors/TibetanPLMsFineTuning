...
model = XLMRobertaForSequenceClassification.from_pretrained("../model/cino-large-v2", num_labels=2, id2label=id2label, label2id=label2id)

training_args = TrainingArguments(
    output_dir="../saved_model/cino-large-v2_tusa",
