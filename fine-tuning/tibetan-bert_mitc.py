...
model = BertForSequenceClassification.from_pretrained("../model/tibetan-bert", num_labels=11, id2label=id2label, label2id=label2id)

training_args = TrainingArguments(
    output_dir="../saved_model/tibetan-bert_mitc",
